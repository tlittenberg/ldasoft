		...
		if(SNR > 7.0)
		{
			...
			*/
			...
			if(SNRX > 7.0)
			{
				...
				loudSNR[2][loudSNRcount] = fabs(params[7]*T*T);			//5:6
				...
				loudSNR[9][loudSNRcount]  = log10(SigmaX[0]/T/params[0]);	//19:20
				loudSNR[10][loudSNRcount] = log10(SigmaX[7]/fabs(params[7]*T*T)); //21:22
